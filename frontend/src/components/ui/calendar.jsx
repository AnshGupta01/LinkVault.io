    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                day: cn(
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-slate-800 rounded-md"
                ),
                day_range_end: "day-range-end",
                day_selected:
                    "bg-slate-100 text-slate-900 hover:bg-slate-100 hover:text-slate-900 focus:bg-slate-100 focus:text-slate-900",
